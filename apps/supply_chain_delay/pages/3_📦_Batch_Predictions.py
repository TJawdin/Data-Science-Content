...
# ============================================================================
# Synthetic Data Generator Function - OPTIMIZED FOR YOUR MODEL
# ============================================================================
...
def generate_synthetic_orders(n_orders=100):
    ...
    Key insight: Shipping cost per km is the #1 predictor!
    - Budget shipping ($0.003-0.012/km) = HIGH RISK
    - Standard shipping ($0.02-0.04/km) = MEDIUM RISK
    - Premium shipping ($0.05-0.10/km) = LOW RISK
    ...
    for i, risk_cat in enumerate(risk_categories):
        ...
        if risk_cat == 'low':
            ...
            # PREMIUM SHIPPING: $0.05-0.10/km (KEY!)
            ...
            # STANDARD SHIPPING: $0.02-0.04/km (KEY!)
...
with col1:
    ...
    **Don't have a CSV file?** Generate synthetic test data with realistic order characteristics!
    ...
    - 🟢 **Low Risk Orders** (~40%) - Premium shipping, short distance, high value
    - 🟡 **Medium Risk Orders** (~40%) - Standard shipping, moderate distance
    - 🔴 **High Risk Orders** (~20%) - Budget shipping, long distance, low value
    
    **Key Insight:** Shipping cost per km is the primary risk factor!
    """)
                ...
                if all_features:
                    ...
                    if predictions is not None:
                        ...
                        with tab2:
                            ...
                            fig_hist = create_risk_distribution(predictions)
