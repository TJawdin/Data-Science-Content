...
def create_brazil_map(view_type, show_markers, show_labels):
    ...
    <p style="margin: 5px 0;"><span style="color: green;">●</span> Low Risk (&lt;10%)</p>
    <p style="margin: 5px 0;"><span style="color: orange;">●</span> Medium Risk (10-25%)</p>
    <p style="margin: 5px 0;"><span style="color: red;">●</span> High Risk (&gt;25%)</p>
    </div>
    '''
